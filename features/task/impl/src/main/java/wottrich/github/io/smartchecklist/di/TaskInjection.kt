...
import wottrich.github.io.smartchecklist.domain.usecase.ObserveTasksFromSelectedChecklistUseCase
...
private fun Module.injectUseCases() {
    ...
    factory { ObserveTasksFromSelectedChecklistUseCase(get()) }
...
private fun Module.injectViewModels() {
    viewModel {
        TaskComponentViewModel(
            observeTasksFromSelectedChecklistUseCase = get(),
