...
class TaskRepositoryImpl(
    ...
    override suspend fun getTasksFromSelectedChecklist(): List<TaskContract> {
        val selectedChecklist = checklistDao.getSelectedChecklist() ?: throw InvalidParameterSpecException()
